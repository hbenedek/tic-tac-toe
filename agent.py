...
class DeepAgent(Agent):
    def __init__(self, epsilon=0.2, gamma=0.99, buffer=10000, batch=64, update_target=500, explore=False):
        self.gamma = gamma
        self.buffer = buffer
        self.batch = batch
        self.epsilon = epsilon
    ...
    def learn(self, agent, N=20000, test_phase=250, self_practice=False):
        history = []
        env = TictactoeEnv()
